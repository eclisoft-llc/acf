DELIMITER $$
CREATE OR REPLACE PROCEDURE CARS_118_CONTENT_REPORTS(IN i_subques_list TEXT, IN i_subques_resp_list TEXT, IN i_amend_where_cond TEXT)
proc_label: BEGIN
...
DECLARE v_crsql TEXT DEFAULT '';
	...
	BEGIN
		...
		WHERE SP_LOG_ID=(SELECT MAX(SP_LOG_ID)FROM CARS_SP_LOG WHERE SP_NAME='CARS_118_CONTENT_REPORTS');
	...
	INSERT INTO CARS_SP_LOG (SP_NAME, SP_STATUS_TEXT, START_TS)
		VALUES('CARS_118_CONTENT_REPORTS', 'Started', NOW());	
...
FROM CARS_118_SUBQUES SQ
JOIN CARS_118_SUBQUES_RESP SR
ON SQ.SUBQUES_ID = SR.SUBQUES_ID
...
AS 
SELECT
DISTINCT H.ENTITY_NAME, A.HDR_AMEND_ID, R.ENTITY_NAME AS REGION_NAME, E.REGION_ID AS REGION_ID, AMEND_SEQ_NUM
...
b_while:
	WHILE v_whilecnt <= v_iter DO
		...
		') 
		SELECT
		ENTITY_NAME, REGION_NAME, REGION_ID, AMEND_SEQ_NUM,  
		MAX(
		...
		LEFT OUTER JOIN CARS_118_HDR_ANS A
...
SET v_sqlhdr = CONCAT('INSERT INTO CARS_TEMP_HEADERS', v_rand, ' SELECT ''State/Territory'', ''Region'', ''REGION_ID'', ''Amendment Number'',  ');
