DROP PROCEDURE IF EXISTS CARS_118A_RELEASE_MULTIQUES_LOCK;

DELIMITER //

CREATE PROCEDURE CARS_118A_RELEASE_MULTIQUES_LOCK (
...
BEGIN
	...
	BEGIN
		...
		WHERE SP_LOG_ID=(SELECT MAX(SP_LOG_ID)FROM CARS_SP_LOG WHERE SP_NAME='CARS_118A_RELEASE_MULTIQUES_LOCK');
		COMMIT; 
	...
	INSERT INTO CARS_SP_LOG (`SP_NAME`, `START_TS`, `END_TS`)
		VALUES( 'CARS_118A_RELEASE_MULTIQUES_LOCK', NOW(), NOW());	
	...
	WHILE v_leave <> 1 DO	
		...
		DELETE FROM CARS_118A_HDR_QUES_PAGE_LOCK
		WHERE
