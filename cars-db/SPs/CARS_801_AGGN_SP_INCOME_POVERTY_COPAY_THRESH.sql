DELIMITER $$
CREATE OR REPLACE PROCEDURE CARS_801_AGGN_SP_INCOME_POVERTY_COPAY_THRESH( IN i_aggn_ref_id INT)
BEGIN
...
DECLARE v_total_rows_inserted INTEGER DEFAULT 0; 
	...
	INSERT INTO CARS_801_SP_LOG ( SP_NAME, START_TS)
		VALUES( 'CARS_801_AGGN_SP_INCOME_POVERTY_COPAY_THRESH', NOW());	
		
		
	SELECT COUNT(*) INTO v_rec_cnt FROM CARS_801_AGGN_INCOME_POVERTY_COPAY_THRESH WHERE  AGGN_REF_ID = i_aggn_ref_id;
 
		DELETE FROM CARS_801_AGGN_INCOME_POVERTY_COPAY_THRESH
...
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_INIT_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_INIT_THRESH AS  
SELECT
    H.MODULE_HDR_ID, 
	H.ENTITY_NAME, 
	H.ENTITY_ID,
...
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_UNADJ_DATA1_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_UNADJ_DATA1_THRESH AS  
SELECT
...
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_UNADJ_DATA_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_UNADJ_DATA_THRESH AS  
SELECT
...
FROM
	...
	FROM CARS_TMP_INCOME_POVERTY_COPAY_UNADJ_DATA1_THRESH
	GROUP BY MODULE_HDR_ID, ENTITY_ID, ENTITY_NAME
	) A
JOIN CARS_TMP_INCOME_POVERTY_COPAY_INIT_THRESH I
ON A.MODULE_HDR_ID = I.MODULE_HDR_ID
;



DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_ADJ_DATA_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_ADJ_DATA_THRESH AS  
SELECT
MODULE_HDR_ID, ENTITY_ID, ENTITY_NAME,
...
(
		...
		FROM CARS_TMP_INCOME_POVERTY_COPAY_UNADJ_DATA_THRESH
) A
;
		
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_AVG_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_AVG_THRESH AS  
SELECT
...
AS TOT_ADJ_CNT
FROM CARS_TMP_INCOME_POVERTY_COPAY_ADJ_DATA_THRESH
GROUP BY ENTITY_ID, ENTITY_NAME;


DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_NATIONAL_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_NATIONAL_THRESH AS  
SELECT
...
FROM CARS_TMP_INCOME_POVERTY_COPAY_AVG_THRESH;


DROP  TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_THRESH;
CREATE  TABLE CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_THRESH AS  
SELECT
ENTITY_ID, ENTITY_NAME, 
...
DROP  TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_NAT_THRESH;
CREATE  TABLE CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_NAT_THRESH AS  
SELECT
0 AS ENTITY_ID, 'National' AS ENTITY_NAME,
AVG((CASE WHEN PROTECTIVE_SVC IS NULL AND INVALID_FAM IS NULL AND POV_PCT > 0 AND POV_PCT < 100 THEN 
		COALESCE(TOTAL_MONTHLY_COPAYMENT, 0) ELSE 0 END) / (CASE WHEN PROTECTIVE_SVC IS NULL AND INVALID_FAM IS NULL AND POV_PCT > 0 AND POV_PCT < 100 THEN 
...
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_INC_RATIO_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_INC_RATIO_THRESH AS  
SELECT
ENTITY_ID, ENTITY_NAME, 
...
FROM CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_THRESH
...
COALESCE(ROUND(COPAY_INC_PCT_150_175, 5),0) AS COPAY_INC_PCT_150_175,
COALESCE(ROUND(COPAY_INC_PCT_GE_175, 5),0) AS COPAY_INC_PCT_GE_175
FROM CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_NAT_THRESH
;

DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_PCT_THRESH;
CREATE TEMPORARY TABLE CARS_TMP_INCOME_POVERTY_COPAY_PCT_THRESH AS  
SELECT
ENTITY_ID, ENTITY_NAME,
...
ROUND((INCOME_GE_175_ADJ_CNT / TOT_ADJ_CNT) * 100, 2) AS INCOME_GE_175_PCT,
100.00 AS TOT_PCT 
FROM CARS_TMP_INCOME_POVERTY_COPAY_NATIONAL_THRESH;


INSERT INTO CARS_801_AGGN_INCOME_POVERTY_COPAY_THRESH
(
AGGN_REF_ID, 
ENTITY_ID, 
ENTITY_NAME, 
...
TOT_ADJ_CNT,
TOT_PCT
FROM CARS_TMP_INCOME_POVERTY_COPAY_AVG_THRESH A
JOIN CARS_TMP_INCOME_POVERTY_COPAY_PCT_THRESH P
ON A.ENTITY_ID = P.ENTITY_ID
JOIN CARS_TMP_INCOME_POVERTY_COPAY_INC_RATIO_THRESH R
...
TOT_ADJ_CNT,
TOT_PCT
FROM CARS_TMP_INCOME_POVERTY_COPAY_NATIONAL_THRESH A
JOIN CARS_TMP_INCOME_POVERTY_COPAY_PCT_THRESH P
ON A.ENTITY_ID = P.ENTITY_ID
JOIN CARS_TMP_INCOME_POVERTY_COPAY_INC_RATIO_THRESH R
ON A.ENTITY_ID = R.ENTITY_ID
...
NULL
FROM CARS_ENTITY E
LEFT OUTER JOIN CARS_TMP_INCOME_POVERTY_COPAY_AVG_THRESH C
...
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_ADJ_DATA_THRESH;
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_AVG_THRESH;
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_THRESH;
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_RATIOPCT_BASE_NAT_THRESH;
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_NATIONAL_THRESH;
DROP TEMPORARY TABLE IF EXISTS CARS_TMP_INCOME_POVERTY_COPAY_INC_RATIO_THRESH;
